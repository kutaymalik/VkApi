    ...
    IRequestHandler<GetMoneyTransferByParametersQuery, ApiResponse<List<AccountTransactionResponse>>>
{
    ...
    public async Task<ApiResponse<List<AccountTransactionResponse>>> Handle(GetMoneyTransferByReferenceQuery request, CancellationToken cancellationToken)
    {
    ...
    public async Task<ApiResponse<List<AccountTransactionResponse>>> Handle(GetMoneyTransferByAccountIdQuery request, CancellationToken cancellationToken)
    {
        var list = await dbContext.Set<AccountTransaction>()
            .Include(x => x.Account)
            .ThenInclude(x => x.Customer)
    ...
    public async Task<ApiResponse<List<AccountTransactionResponse>>> Handle(GetMoneyTransferByParametersQuery request, CancellationToken cancellationToken)
    {
